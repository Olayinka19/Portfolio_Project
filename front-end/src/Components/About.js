...
<Accordion>
      <Accordion.Item eventKey="0">
        ...
        <img src="https://m.media-amazon.com/images/I/71lj9Fdeq0L._AC_SL1500_.jpg" width="180px" height="180px"></img>
        <Button><a href="https://amzn.to/3kysmET" target="_blank">Learn More</a></Button>
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="1">
        <Accordion.Header>Ring Video Doorbell <img src="https://cdn-icons-png.flaticon.com/512/1333/1333342.png" width="40px" height="40px"></img></Accordion.Header>
        <Accordion.Body>
        ...
        <Button><a href="https://amzn.to/3EEwpGs" target="_blank">Learn More</a></Button>
        </Accordion.Body>
      </Accordion.Item>
